#!/usr/bin/env bash
# Thompson variance measurement: 10 independent runs × 5 sessions, 1yr
...
TOTAL_RUNS=10
SESSIONS=5
LOGDIR="thompson-variance-1yr"

echo "=== Thompson Variance Benchmark (1yr) ==="
...
echo "=== All Thompson variance (1yr) runs complete === $(date)"
