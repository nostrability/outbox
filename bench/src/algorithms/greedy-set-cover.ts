...
/**
 * Greedy Set-Cover (Gossip/Applesauce/Wisp style)
 * Iterative: pick relay covering most uncovered pubkeys, repeat.
...
export function greedySetCover(
  ...
  for (const [relay, writers] of input.relayToWriters) {
    // Only include pubkeys that are actually in our follow set
